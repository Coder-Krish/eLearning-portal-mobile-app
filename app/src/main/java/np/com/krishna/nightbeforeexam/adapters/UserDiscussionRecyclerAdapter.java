...
public class UserDiscussionRecyclerAdapter extends RecyclerView.Adapter<UserDiscussionRecyclerAdapter.UserDiscussionViewHolder> {
    Context context;
    ArrayList<DiscussionForum> discussions;

    public UserDiscussionRecyclerAdapter(Context context, ArrayList<DiscussionForum> discussions) {
    ...
    @NonNull
    @Override
    public UserDiscussionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_my_discussions, parent, false);
        UserDiscussionRecyclerAdapter.UserDiscussionViewHolder userDiscussionViewHolder = new UserDiscussionRecyclerAdapter.UserDiscussionViewHolder(view);
        return userDiscussionViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull UserDiscussionViewHolder holder, int position) {
    ...
    public class UserDiscussionViewHolder extends RecyclerView.ViewHolder {
        ...
        public UserDiscussionViewHolder(@NonNull View itemView) {
            super(itemView);
